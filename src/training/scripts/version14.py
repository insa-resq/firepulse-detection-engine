...
OUTPUT_DIR = Path("dataset-yolo-14-no-firepred")
    ...
    for tif in tifs:
        ...
        with rasterio.open(tif) as src:
            ...
            if "viirs_day" in fname:
                ...
                continue  # On ignore firepred maintenant
...
images_with_labels = [p for p in images_with_labels if Path(p).exists()]
...
print("\n✅ DONE")
print(f"Total images with fire: {N}")
